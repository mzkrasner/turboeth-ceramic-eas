...
export const writeComposite = async (spinner) => {
  ...
  const attestationComposite = await createComposite(ceramic, './composites/attestation.graphql')
  ...
  const confirmConnectSchema = readFileSync('./composites/confirmConnect.graphql', {
    encoding: 'utf-8',
  })
  ...
  const composite = Composite.from([attestationComposite, confirmComposite, confirmConnectComposite])

  await writeEncodedComposite(composite, './src/__generated__/definition.json')
  spinner.info('creating composite for runtime usage')
  await writeEncodedCompositeRuntime(ceramic, './src/__generated__/definition.json', './src/__generated__/definition.js')
