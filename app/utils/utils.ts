...
export const alchemyApiKey = 'nddPfNcyhyl3-oF-Y6dzv-fFRtyyb6AE'
...
export async function getAddressForENS(name: string) {
  const provider = new ethers.providers.StaticJsonRpcProvider(`https://eth-mainnet.g.alchemy.com/v2/${env.REACT_APP_ALCHEMY_API_KEY}`, 'mainnet')
